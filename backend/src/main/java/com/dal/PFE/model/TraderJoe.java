...
@Entity
@Table(name = "traderjoe")
public class TraderJoe {
    ...
    public TraderJoe(int martProdId, int productId, double productPrice, double priceQuantity, String unit, String productDescription, boolean productAvailability) {
